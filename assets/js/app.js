...
const getNews = async () => {
  const data = await fetch(`https://api.nytimes.com/svc/search/v2/articlesearch.json?q=crypto-currency&sort=newest&api-key=${global.newsApi.apiKey}&page=${global.currentPage}`);
